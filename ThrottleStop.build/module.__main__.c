...
static void createModuleCodeObjects(void) {
    ...
    codeobj_da5c1047806a7ee48cb11ee4528476a2 = MAKE_CODEOBJECT(module_filename_obj, 1, CO_NOFREE, mod_consts[25], NULL, NULL, 0, 0, 0);
}
...
NUITKA_CROSS_MODULE PyObject *impl___main__$$$function__5_complex_call_helper_pos_star_list(PyObject **python_pars) {
    ...
    branch_yes_1:;
    {
        ...
        tmp_result = HAS_ATTR_BOOL(tmp_expression_value_1, mod_consts[7]);
...
// Mark the execution in the "__spec__" value.
    ...
    }
    {
        ...
        frame_da5c1047806a7ee48cb11ee4528476a2->m_frame.f_lineno = 1;
        tmp_imported_value_2 = IMPORT_MODULE1(mod_consts[17]);
